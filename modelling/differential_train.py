...
from utils.utils import train_val_test_split, get_past_state_X, get_gleaned_past_state_X
import torch
...
if __name__ == "__main__":
    ...
    # model_path = "ckpt_may/2nd_collect_simplepredictor_50_visible_smoothed_less_differential_0_layer_linear.pt"
    # model_path = "ckpt_may/best_psnn_100_visible_differential.pt"
    model_path = "ckpt_may/2nd_corrected_psnn_10_visible_differential.pt"
    # model_path = "ckpt_may/2nd_collect_simple_differential_1_layer_linear_2D.pt"
