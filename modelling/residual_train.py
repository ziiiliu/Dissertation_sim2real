...
def train_residual(model, X_train, y_train, X_val, y_val, 
...
if __name__ == "__main__":
    ...
    model_path = "ckpt/2nd_collect_psnn_1_visible_residual.pt"
    ...
    y = (ref_states[:-1, :input_dim] - cur_states[1:, :input_dim])[n_visible-1:]
    ...
    train_residual(model, X_train, y_train, X_val, y_val, epochs=epochs, model_save_path=model_path, lr=5e-4, opt="adam", writer=writer) 