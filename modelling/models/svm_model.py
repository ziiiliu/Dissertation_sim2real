...
if __name__ == "__main__":
    ...
    # svr = SVR(kernel='rbf')
    svr = LinearSVR(random_state=20, dual=False, loss='squared_epsilon_insensitive')

    # Create the Multioutput Regressor
    mor = MultiOutputRegressor(svr)
    mor.fit(X_train,y_train)
    dump(mor, "base_ckpt/2nd_svr_10_visible_differential.pt")

    test_preds = mor.predict(X_test)
